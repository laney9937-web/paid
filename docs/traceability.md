...
| AUTH-001 | 10_ D | Magic-link high entropy, hashed, short-lived | issueMagicLink/peekMagicLink/consumeMagicLink; `/api/creator/magic-link` + continue/submit | tests/magic-link-http.test.ts; tests/e2e/magic-link.spec.ts; I-02 I-05 | vitest+playwright | local | VERIFIED | integrating agent | Token only in outbox/email continueUrl; GET continue peeks; GET consume 405 |
