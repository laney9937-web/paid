...
**Commit:** `7a86e58d107bf77ab16fd04fa21982236a5d9cab`
...
| BUILD-003 | 10_ A | web, ops, worker run locally | apps/web, apps/ops, apps/worker | pnpm verify builds + Playwright webServers | playwright.config.ts | local+CI | VERIFIED | integrating agent | local :3000/:3001; CI Playwright :3100/:3101; migrations through 0005; dual-verify + Actions `7a86e58d107bf77ab16fd04fa21982236a5d9cab` |
...
| AUTH-001 | 10_ D | Magic-link high entropy, hashed, short-lived | issueMagicLink/peekMagicLink/consumeMagicLink; envelope-encrypted continue URL | tests/magic-link-http.test.ts; tests/e2e/magic-link.spec.ts; I-02 I-05 | vitest+playwright | local | VERIFIED | integrating agent | HMAC at rest; AES-256-GCM envelope for delivery URL; GET continue peeks; GET consume 405 |
